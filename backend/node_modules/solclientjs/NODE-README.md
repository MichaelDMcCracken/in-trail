...
for use in conjunction with one or more Solace Event Brokers.  By using this
software, you are agreeing to the license terms and conditions located at
https://solace.com/license-software.


## INTRODUCTION
This is the Solace Messaging API for Node.js. This API allows Node.js applications
to send messages to, and receive messages from, a Solace Event Broker.
